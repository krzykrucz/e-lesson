package com.krzykrucz.elesson.currentlesson.preparedness.adapters.eventpublisher
...
class EventPublisherAdapter {
    ...
    ): NotifyStudentMarkedUnprepared = EventPublisher(applicationEventPublisher)
}