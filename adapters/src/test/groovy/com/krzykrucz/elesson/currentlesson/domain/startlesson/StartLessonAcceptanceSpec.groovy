...
import com.krzykrucz.elesson.currentlesson.domain.startlesson.adapters.rest.ClassRegistryResponse
import com.krzykrucz.elesson.currentlesson.domain.startlesson.adapters.rest.StartLessonRequest
...
class StartLessonAcceptanceSpec extends AcceptanceSpec {
    ...
    def "should start lesson"() {
        ...
        def lessonIdAndStudents = rest.exchange(
                "/startlesson",
                HttpMethod.POST,
                new HttpEntity<>(new com.krzykrucz.elesson.currentlesson.domain.startlesson.adapters.rest.StartLessonRequest('Severus', 'Snape')),
                com.krzykrucz.elesson.currentlesson.domain.startlesson.adapters.rest.ClassRegistryResponse
        ).body
